...
thumbnail_frame_matcher.yml| A thumbnail resolution improving scraper. | This ruby scraper uses the current thumbnail of a scene to find and extract the matching frame from the video. This can be used to improve thumbnail quality from certain sites. Read more [here](/scrapers/thumbnail_frame_matcher/README.md) | [#1121](https://github.com/stashapp/CommunityScrapers/pull/1121)
