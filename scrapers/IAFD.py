...
def performer_from_tree(tree):
    ...
    if p.birthdate:
        ...
        try:
            p.birthdate = datetime.datetime.strptime(p.birthdate, iafd_date).strftime(
                stash_date
            )
        except:
            p.birthdate = None
    ...
    performer_deathdate = tree.xpath(
    ...
    if p.death_date:
        ...
        try:
            p.death_date = datetime.datetime.strptime(p.death_date, iafd_date).strftime(
                stash_date
            )
        except:
            p.death_date = None
    ...
    performer_ethnicity = tree.xpath(
...
def movie_from_tree(tree):
    ...
    if m.date:
        try:
            m.date = datetime.datetime.strptime(m.date, iafd_date_scene).strftime(
                stash_date
            )
        except:
            m.date = None
    ...
    if movie_studio:
        ...
        m.studio = m.set_named_value("name", distributor)
