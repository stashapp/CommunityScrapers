...
print(
    json.dumps(
        {
            "title": "ManyVids - A Helpful Userscript for the Que",
            "date": "2024-06-12",
            "details": "Lorem ipsum dolor sit amet, consec...",
            "director": "Jamie Films",
            "urls": ["https://demo.rescrape.test/scenes/userscript-demo-scene"],
            ...
            "image": "https://placehold.co/960x540/slategrey/white?text=Example%20cover%20image",
        }
    )
)
